 ...
 * @link https://app.launchdarkly.com/default/production/features/fflag_feat_front_lsdv_e_279_enhanced_paragraph_annotation_short
 */
export const FF_NER_SELECT_ALL = "fflag_feat_front_lsdv_e_279_enhanced_paragraph_annotation_short";
