...
import { IconUpload, IconInbox } from "@humansignal/icons";
...
describe("EmptyState Component", () => {
  ...
  it("applies correct size classes", () => {
    const { container, rerender } = render(
      <EmptyState {...defaultProps} size="large" data-testid="empty-state" />
    );
  ...
  it("applies correct variant classes", () => {
    const { rerender } = render(
      <EmptyState {...defaultProps} variant="primary" data-testid="empty-state" />
    );
  ...
  it("renders icon with correct size based on size prop", () => {
    const { rerender } = render(
      <EmptyState {...defaultProps} size="large" />
    );
  ...
  it("renders single action with center alignment", () => {
    render(
      <EmptyState 
        {...defaultProps}
        actions={
          <Button data-testid="single-action">Single Action</Button>
        }
      />
    );
