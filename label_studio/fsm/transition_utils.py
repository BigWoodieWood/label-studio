...
def execute_transition_instance(
    entity: Model,
...
def create_transition_from_dict(
    transition_class: Type[BaseTransition],
    data: Dict[str, Any]
) -> BaseTransition:
    """
...
def transition_state_declarative(
    entity: Model,
    transition_name: str,
    user=None,
    **transition_data
