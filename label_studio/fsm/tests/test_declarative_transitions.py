...
from fsm.state_choices import TaskStateChoices, AnnotationStateChoices
...
class TransitionUtilsTests(TestCase):
    ...
    def test_transition_builder(self, mock_execute):
        ...
        result = (TransitionBuilder(self.task)
...
class ExampleTransitionIntegrationTests(TestCase):
    ...
    def setUp(self):
        ...
        from fsm.example_transitions import (
            StartTaskTransition,
            CompleteTaskTransition,
            SubmitAnnotationTransition
        )
    ...
    def test_transition_data_generation(self):
        ...
        transition = StartTaskTransition(
...
class ComprehensiveUsageExampleTests(TestCase):
    ...
    def test_complex_validation_example(self):
        ...
        invalid_transition = TaskAssignmentTransition(
            assignee_id=456,
    ...
    def test_hooks_and_lifecycle_example(self):
        ...
        transition = NotificationTransition(
            notification_message="Task has been updated",
    ...
    def test_conditional_transition_example(self):
        ...
        high_confidence_transition = ConditionalApprovalTransition(
        ...
        context = TransitionContext(
            ...
            target_state=high_confidence_transition.target_state
        )
        ...
        low_confidence_transition = ConditionalApprovalTransition(
...
class ValidationAndErrorHandlingTests(TestCase):
    ...
    def test_business_logic_validation_errors(self):
        ...
        invalid_currency_transition = BusinessRuleTransition(
            amount=100,
            currency="XYZ"
        )
        with self.assertRaises(TransitionValidationError) as cm:
        ...
        multi_error_transition = BusinessRuleTransition(
            amount=-50,
            currency="XYZ"
        )
        with self.assertRaises(TransitionValidationError) as cm:
    ...
    def test_context_validation_errors(self):
        ...
        class ContextAwareTransition(BaseTransition):
            ...
            def validate_transition(self, context: TransitionContext) -> bool:
                ...
                if context.is_initial_transition and self.action != "create":
                    raise TransitionValidationError(
                        "Initial transition must be 'create' action",
                        {"action": self.action, "is_initial": True}
                    )
        ...
        initial_context = TransitionContext(
            entity=self.task,
            current_state=None,  # No current state = initial
            target_state="ACTIONED"
        )
        ...
        completed_context = TransitionContext(
            entity=self.task,
