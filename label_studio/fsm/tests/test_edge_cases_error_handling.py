...
class EdgeCasesAndErrorHandlingTests(TestCase):
    ...
    def test_extreme_data_sizes(self):
        ...
        context = TransitionContext(
            ...
            target_state=large_string_transition.target_state
        )
    ...
    def test_circular_reference_handling(self):
        ...
        result = transition.transition(context)
        self.assertEqual(
            result["edge_case_data"]["level1"]["level2"]["level3"]["data"], 
            "deep_value"
        )
    ...
    def test_memory_pressure_and_cleanup(self):
        ...
        none_count = sum(1 for ref in weak_refs if ref() is None)
        ...
        new_context = TransitionContext(
            entity=self.mock_entity,
            current_state="CREATED",
            target_state=new_transition.target_state
        )
    ...
    def test_exception_during_transition_execution(self):
        ...
        fail_transition = ErrorProneTransition(
            should_fail="yes", 
    ...
    def test_registry_edge_cases(self):
        ...
        original_class = EdgeCaseTransition
    ...
    def test_context_edge_cases(self):
        ...
        empty_context = TransitionContext(
            entity=self.mock_entity,
            current_state="",  # Empty string state
            target_state="PROCESSED"
        )
    ...
    def test_transition_builder_edge_cases(self):
        ...
        builder = (TransitionBuilder(self.mock_entity)
                  ...
                  .with_data(edge_case_data="second"))  # Should overwrite
        ...
        def error_worker(worker_id):
            ...
            try:
                ...
                transition = ErrorProneTransition(
                    should_fail="yes",
                    failure_stage="validation" if worker_id % 2 == 0 else "transition"
                )
    ...
    def test_resource_cleanup_after_errors(self):
        ...
        context = TransitionContext(
            entity=self.mock_entity,
            current_state="CREATED",
            target_state=success_transition.target_state
        )
        ...
        success_ref = weakref.ref(success_transition)
        fail_ref = weakref.ref(fail_transition)
